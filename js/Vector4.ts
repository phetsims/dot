...
export default class Vector4 implements TPoolable {
  ...
  public static pool = new Pool( Vector4, {
    maxSize: 1000,
  ...
  public static ZERO: Vector4; // eslint-disable-line statics-should-be-readonly
  public static X_UNIT: Vector4; // eslint-disable-line statics-should-be-readonly
  public static Y_UNIT: Vector4; // eslint-disable-line statics-should-be-readonly
  public static Z_UNIT: Vector4; // eslint-disable-line statics-should-be-readonly
  public static W_UNIT: Vector4; // eslint-disable-line statics-should-be-readonly
}
