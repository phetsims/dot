...
(function() {
  ...
  test( 'plus / add', function() {
    var a = A(), b = B();
    var result = new Matrix3( 0.583184, -1.32807, 0.400818, -0.207545, 0.401791, 0.882298, 0.81168, 0.370878, -0.0835274 );
  ...
  test( 'minus / subtract', function() {
    var a = A(), b = B();
    var result = new Matrix3( -0.149837, 0.417574, -0.580365, -0.3163, -0.819726, -1.04049, -0.949493, -1.61117, 0.634326 );
  ...
  test( 'transposed / transpose', function() {
    var a = A();
    var result = new Matrix3( 0.216673, -0.261922, -0.0689069, -0.455249, -0.208968, -0.620147, -0.0897734, -0.0790977, 0.275399 );
  ...
  test( 'negated / negate', function() {
    var a = A();
    var result = new Matrix3( -0.216673, 0.455249, 0.0897734, 0.261922, 0.208968, 0.0790977, 0.0689069, 0.620147, -0.275399 );
  ...
  test( 'inverted / invert', function() {
    var a = A();
    var result = new Matrix3( 1.48663, -2.52483, -0.240555, -1.08195, -0.745893, -0.566919, -2.06439, -2.31134, 2.29431 );
  ...
  test( 'timesMatrix / multiplyMatrix', function() {
    var a = A(), b = B();
    var result = new Matrix3( -0.0243954, -0.556133, -0.299155, -0.177013, 0.0225954, -0.301007, 0.183536, -0.0456892, -0.72886 );
